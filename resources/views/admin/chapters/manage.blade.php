        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-8"><A href="{{route('admin.exportchapters')}}"><button type="button" class="btn btn-primary">Download As Excel</button></A></div>
                <div class="col-sm-4">
...
{
  window.location.href = "{{url('admin/EditChapters')}}" + "/" + id;
}
    ...
    buttons: {   
        ok: {
            ...
            keys: ['enter'],
            action: function(){
              $.post("{{ url('admin/DeleteChapterRecord') }}",{id:id, _method: 'POST', _token: '{{ csrf_token() }}'})
          ...
          console.log(response);
              ...
              if(response.success == 1)
              {
                ...
                window.location.href = "{{url('admin/ManageChapters')}}" + "/<?php echo $pagenumber; ?>";
              }
              else
              {
                toastr.error(response.message);
