        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('admin.updatechapterpost') }}" method="post" id="updatechaptersform">
                @csrf
              ...
              @endif
                ...
                <input type="hidden" name="version_hide" id="version_hide" value="0">
              ...
              @if($chapters != false)
                ...
                <?php $chapter_name=$row['chapter_name']; ?>
                <?php $chapter_number=$row['chapter_num']; ?>
                <?php $meta_keyword=$row['meta_keyword']; ?>
                <?php $meta_description=$row['meta_description']; ?>
              ...
              @endif
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7">
                    ...
                    <input type="text" class="form-control" placeholder="Chapter Name" id="chapter_name" name="chapter_name" value="{{$chapter_name}}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7">
                    ...
                    <input type="text" class="form-control" placeholder="Chapter Number" id="chapter_num1" name="chapter_num1" value="{{$chapter_number}}" disabled>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <center><button type="button" class="btn btn-primary editrecords">Update Chapters</button><center>
                  </div>
                </div>
                  </div>
                </div>
