        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('admin.addrecordpost') }}" method="post" id="addrecordsform">
                @csrf
              ...
              @endif
                ...
                <span class="col-sm-1"></span>
                  ...
                  <div class="col-sm-7">
                    <textarea class="form-control" placeholder="Vers Content" name="vers_content" id="vers_content" style="height: 100px"></textarea>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <center><button type="button" class="btn btn-primary addrecords">Add Records</button><center>
                  </div>
                </div>
                  </div>
                </div>
