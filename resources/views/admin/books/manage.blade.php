...
@include('others.sidebar')  
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-8"><A href="{{route('admin.exportbooks')}}"><button type="button" class="btn btn-primary">Download As Excel</button></A>
              </div>
                <div class="col-sm-4">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Book Short Title</th>
 ...
 <?php $sno=0; ?>
   @if($books != false)
      ...
      <tr>
      <td scope="col">{{ $sno }}</td>
      <td scope="col">{{ $row['book_num'] }}</td>
      <td scope="col">{{ $row['title'] }}</td>
      <td scope="col">{{ $row['short_title'] }}</td>
      <td scope="col">{{ $row['meta_keyword'] }}</td>
      <td scope="col">{{ $row['meta_description'] }}</td>
...
{
  window.location.href = "{{url('admin/EditBooks')}}" + "/" + id;
}
$('#pagenumber').change(function()
{
  window.location.href = "{{url('admin/ManageBooks')}}" + "/" + $(this).val();
});
    ...
    buttons: {   
        ok: {
            ...
            keys: ['enter'],
            action: function(){
              $.post("{{ url('admin/DeleteBookRecord') }}",{id:id, _method: 'POST', _token: '{{ csrf_token() }}'})
          ...
          console.log(response);
              ...
              if(response.success == 1)
              {
                ...
                window.location.href = "{{url('admin/ManageBooks')}}" + "/<?php echo $pagenumber; ?>";
              }
              else
              {
                toastr.error(response.message);
