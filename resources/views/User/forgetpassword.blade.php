...
.btn-login {
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <li><a class="dropdown-item" href="{{ route('user.logout') }}">Logout</a></li>
      ...
      <input type="hidden" nmae="emailaddresshide" id="emailaddresshide" value=0>
        ...
        <div class="container">
        <form action="{{url('user/ForgetPasswordPost')}}" method="post" id="formid">
            @csrf
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          ...
          @if (\Session::has('success'))
              ...
              @endif
            <h5 class="card-title text-center mb-5 fw-light fs-5">Forget Password</h5>
            <form class="row g-3">
  ...
  <div class="col-12 mt-2" >
    <center><button type="button"  class="btn btn-primary sendotp">Send OTP</button></center>
  </div>
    ...
    $(document).ready(function(){
      ...
      $('#emailaddress').keyup(function()
      {
        if($(this).val().length == 0)
        {
          ...
          $('.emailaddresserror').html('<font color="red">Email ID is Required</font>');
        }
        else
        {
