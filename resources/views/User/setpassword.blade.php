...
.btn-login {
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <input type="hidden" nmae="reenterpasswordhide" id="reenterpasswordhide" value=0>
        <div class="container">
        <form action="{{url('user/SetPasswordPost')}}" method="post" id="formid">
            @csrf
  ...
  <div class="col-md-12">
    <label for="inputEmail4" class="form-label">ReEnter Password</label>
    <input type="email" class="form-control" id="reenterpassword" name="reenterpassword">
    <span class="reenterpassworderror"></span>
    <span class="passwords"></span>
  </div>
 
 
  <div class="col-12 mt-2" >
    <center><button type="button"  class="btn btn-primary setpassword">Set</button></center>
  </div>
    ...
    $(document).ready(function(){
      $('.setpassword').click(function()
      {
        ...
        if($('#passwordhide').val() == 1 && $('#reenterpasswordhide').val() == 1)
        {
          ...
          {
            $('.passwords').html('<font color="red">Passwords Not Equal</font>');
          }
      ...
      $('#reenterpassword').keyup(function()
      {
        if($(this).val() == '')
        {
          $('#reenterpasswordhide').val(0);
          $('.reenterpassworderror').html('<font color="red">Password is Required</font>');
        }
        else
        {
          $('#reenterpasswordhide').val(1);
