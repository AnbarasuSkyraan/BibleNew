...
.btn-login {
  ...
  <body>
    <input type="hidden" nmae="namehide" id="namehide" value=0>
    <input type="hidden" nmae="mobilenohide" id="mobilenohide" value=0>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <li><a class="dropdown-item" href="{{ route('user.logout') }}">Logout</a></li>
        ...
        <div class="container">
          <form action="{{url('user/RegistrationPost')}}" method="post" id="formid">
            @csrf
  ...
  <div class="col-12 mt-2">
    <center><button type="button"  class="btn btn-primary signupbutton">Sign Up</button></center>
  </div>
</form>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      {
        alert($('#namehide').val());
        alert($('#emailaddresshide').val());
        alert($('#mobilenohide').val());
        alert($('#passwordhide').val());
        if($('#namehide').val() == 1 && $('#emailaddresshide').val() == 1 && $('#mobilenohide').val() == 1 && $('#passwordhide').val() == 1)
        {
          $('#formid').submit();
        }
      ...
      $('#name').keyup(function()
      {
        ...
        {
          $('#namehide').val(0);
          $('.nameerror').html('<font color="red">Name is Required</font>');
        }
        else
        {
          $('#namehide').val(1);
      ...
      $('#mobileno').keyup(function()
      {
        ...
        {
          $('#mobilenohide').val(0);
          $('.mobilenoerror').html('<font color="red">Mobile No is Required</font>');
        }
        else
        {
          ...
          { 
            $('#mobilenohide').val(0);
          $('.mobilenoerror').html('<font color="red">Only Allowed 10 Digits</font>');
          }
          else
          {
            $('#mobilenohide').val(1);
